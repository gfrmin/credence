# Superseded: Move 2 routing benchmark results

> **This report is superseded.** The routing-collapse findings below motivated
> Posture 5's strategic shift from model-tier routing to Bayesian governance
> sidecar (see `docs/posture-5/master-plan.md`). The headline 67.4%
> token-volume-weighted cost savings was an artefact of always-Haiku selection
> — the Bayesian router never explored Sonnet or Opus because Haiku's
> quality-per-dollar ratio dominated the EU calculation at standard Anthropic
> pricing. This is a structural property of scalar-score-trained routers
> (arXiv:2602.03478), not a Credence-specific bug. The report is preserved as
> forensic record of the routing-collapse phenomenon and as primary data
> source for the eventual Paper One (post-MVP publication track).
